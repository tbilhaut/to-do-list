...
<body>
  ...
  try { // Connexion à la base de donnée 
    ...
    /*
    while ($taches = $resultat->fetchAll()) { // On initialise une boucle
  ?>
      <tr>
...
*/
    ...
    if(isset($_POST["add"]))
    {
        $reponse = "INSERT INTO tache (nomtache, date-heure) VALUES ('".$_POST["newtache"]."','".$_POST["laDate"]."')"; // On exécute une requête visant à récupérer les tâches
        $resultat = $GLOBALS["pdo"]->query($reponse);
    }
  ?>
              ...
              <div class="card-body py-4 px-4 px-md-5">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <form class="d-flex flex-row align-items-center" method="post">
                        <input type="text" class="form-control form-control-lg" id="exampleFormControlInput1" placeholder="Nouvelle tache..." name="newtache">
                        
                        <a href="#!" data-mdb-toggle="tooltip" title="Set due date" ></script><input type="datetime-local" name="laDate"></a>
                        
                        <div>
                          <button type="button" class="btn btn-primary" name="add">Ajouter la tache</button>
                        </div>
                      </form>
                    </div>
                  </div>
                ...
                <div class="d-flex justify-content-end align-items-center mb-4 pt-2 pb-3">
                  ...
                  <select class="select">
                    ...
                    <option value="2">A rendre rapidement</option>
                  </select>
                ...
                <ul class="list-group list-group-horizontal rounded-0">
                  ...
                  <li class="list-group-item px-3 py-1 d-flex align-items-center flex-grow-1 border-0 bg-transparent">
                    <p class="lead fw-normal mb-0 bg-light w-100 ms-n2 ps-2 py-1 rounded">Renew car insurance</p>
                  </li>
                  </li>
                ...
                <?php
                foreach ($tabresultat as $ToDoList) {
                ...
                ?>
                  <ul class="list-group list-group-horizontal rounded-0">
                    ...
                    <li class="list-group-item px-3 py-1 d-flex align-items-center flex-grow-1 border-0 bg-transparent">
                      <p class="lead fw-normal mb-0 bg-light w-100 ms-n2 ps-2 py-1 rounded"><?php echo $ToDoList["pseudo"] ?></p>
                    </li>
                    </li>

                    <li class="list-group-item px-3 py-1 d-flex align-items-center flex-grow-1 border-0 bg-transparent">
                      <p class="lead fw-normal mb-0 bg-light w-100 ms-n2 ps-2 py-1 rounded"><?php echo $ToDoList["nomtache"] ?></p>
                    </li>
